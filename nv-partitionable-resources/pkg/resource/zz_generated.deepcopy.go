...
func (in *DeviceMixin) DeepCopyInto(out *DeviceMixin) {
	*out = *in
	if in.Partitionable != nil {
		in, out := &in.Partitionable, &out.Partitionable
		*out = new(PartitionableDeviceMixin)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitionableDevice) DeepCopyInto(out *PartitionableDevice) {
	*out = *in
	if in.Includes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PartitionableDevice.
func (in *PartitionableDevice) DeepCopy() *PartitionableDevice {
	if in == nil {
		return nil
	}
	out := new(PartitionableDevice)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitionableDeviceMixin) DeepCopyInto(out *PartitionableDeviceMixin) {
	*out = *in
	if in.Attributes != nil {
		in, out := &in.Attributes, &out.Attributes
		*out = make(map[QualifiedName]DeviceAttribute, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PartitionableDeviceMixin.
func (in *PartitionableDeviceMixin) DeepCopy() *PartitionableDeviceMixin {
	if in == nil {
		return nil
	}
	out := new(PartitionableDeviceMixin)
